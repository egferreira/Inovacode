...
class Pomodoro(Thread):
    ...
    def run(self):        
        ...
        #easygui.msgbox("\nIt is now "+t_now.strftime("%H:%M") + " hrs. \nTimer set for 25 mins.", title="Pomodoro Started")                                                
        # Main script
        ...
        while ( True):
            ...
            #Pomodoro and break finished. Check if ready for another pomodoro!
                ...
                #sr_ans = easygui.ynbox('Pomodoro Finished \n Shall I continue?', 'Pomodoro', ('Yes', 'No'))                
                ...
                if usr_ans == True:
                    ...
                    #easygui.msgbox( "\nIt is now "+self.timenow + "\nYou completed "+str(total_pomodoros)+ " pomodoros today!", title="Pomodoro Finished!")                                                                                        
                    break
